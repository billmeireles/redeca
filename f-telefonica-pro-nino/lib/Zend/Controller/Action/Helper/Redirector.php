...
class Zend_Controller_Action_Helper_Redirector extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function setGotoUrl($url, array $options = array())
    {
        ...
        $this->_redirect($url);
							...
							/*
							* Método utilizado na versão 1.0.3 do Zend
							* Não é compatível com versões 5.3.x do PHP
							*/
	...
	*/
	...
	/* ///////////////////////////////////////////////////////////////////
	* Método retirado da versão 1.11.5 do Zend ///////////////////////////
	* ////////////////////////////////////////////////////////////////////
	*
	* Método utilizado nas versões mais recentes do Zend
	* O método acima (goto) não é mais suportado pelo PHP 5.3.x
	*/
	...
	* ////////////////////////////////////////////////////////////////////
	*
	* Método utilizado em todas as versões do Zend, sendo seu corpo retirado da versão Zend 1.11.5
	*/
    public function direct($action, $controller = null, $module = null, array $params = array())
    {
        //$this->goto($action, $controller, $module, $params); ESTE MÉTODO NÃO É COMPATÍVEL NA VERSÃO 5.3.x DO PHP
		
		/* 
		* Chamada de novo método (chamada utilizada na versão 1.11.5 do Zend
		*/
