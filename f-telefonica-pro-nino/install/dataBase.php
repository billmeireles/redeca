 ...
 */
	...
	require_once('template'.DIRECTORY_SEPARATOR.'_validationEnvironment.php');
	require_once('template'.DIRECTORY_SEPARATOR.'_recommendedSettings.php');
	
	$step = 2;
 
	// verificação adequada do ambiente
		...
		<div class="centerBox">
			...
			<div id="content-box">
				<div id="content-pad">
					...
					<?php require_once('template'.DIRECTORY_SEPARATOR.'_configurationDatabase.php'); ?>
				</div>
			</div> 
