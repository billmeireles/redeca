		...
		<div id="rightpad">
			...
			<div id="installer">
				...
				<div class="m" style="float: left; width: 544px;">
					<h2 class="borderBotton">Parabéns! O Redeca está instalado.</h2>
					<div class="install-text" style="width: 544px;">
						<p>Clique no botão "Acessar o sistema" para conferir o sistema.</p>
					</div>
						...
						<div class="m">
							<fieldset>
								<table class="final-table" cellpadding="0" cellspacing="0" align="left">
									<tr>
										<td class="error">
											LEMBRE-SE DE REMOVER O DIRETÓRIO 'INSTALL' COMPLETAMENTE.
											Você não poderá passar deste ponto, até que o diretório install seja removido. Esta é uma medida de segurança do Redeca.
										</td>
									</tr>
									<tr>
										<td>
											<h3 style="margin-top: 25px; font-size: 16px;">Detalhes da Sessão do Administrador</h3>
											<p>Nome de Usuário: root</p>
										</td>
									</tr>
										...
										<td class="notice">
											<div id="cpanel">
												<div class="icon" style="margin-top: 25px;">
													...
													<br />												
													Visite a comunidade do Redeca, através do <a style="text-decoration: underline;" href="http://www.softwarepublico.gov.br/ver-comunidade?community_id=18016032" target="_blank">Portal do Software Público Brasileiro</a> para maiores informações, documentos e download de novas versões. 
