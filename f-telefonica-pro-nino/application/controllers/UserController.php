...
class UserController extends BasicController
{
	...
	{	
		//valida as informaçãões inseridas no form pelo usuário  
		$errorMessages = UserValidator::validateChangePassword($this->view->form);
		
		if(sizeof($errorMessages) > 0)
		{
			//carrega variável com a(s) mensagem(ens) de erro de validaçãnão
			$this->view->errorMessages = $errorMessages;
			
			//Retorna para o template atual exibindo as mensagens de validaçãnão
			return;
		}
	...
	/**
	 * Exibe formulário para criaçãnão de um novo usuário
	 */
	function newAction()
	{
		$admin = UserLogged::isAdministrator();
	...
	/**
	 * Exibe formulário para ediçãnão de um usuário
	 */
	function viewAction()
	{
