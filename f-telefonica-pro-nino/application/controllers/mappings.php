...
define('DEFAULT_SEND_FORM_ACTION', 			'sendform');
define('DEFAULT_SEND_SUCCESS_ACTION', 		'sendsuccess');
define('DEFAULT_EDIT_VACCINATION_ACTION',   'vaccinationEdit');
define('DEFAULT_DISABLE_VACCINATION_ACTION','vaccinationDisab');
...
define('VALIDATE_REPORT_ACTION',			'validateReport');
...
define('DEFAULT_DELETE_ACTION', 			'delete');
define('DEFAULT_PERSON_MIGRATE_ACTION',		'migratePerson');
define('DEFAULT_PROPERTIES_ACTION',			'properties');
...
define('MONITORING_CONTROLLER',             '/monitoring');
