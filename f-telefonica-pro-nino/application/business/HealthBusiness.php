...
class HealthBusiness extends BasicBusiness
{
	...
	/**
	 * Carrega do banco as informações de unidade de atendimento conforme seu "id"
	 */
	...
	/**
	 * Carrega do banco as informações de vacina conforme seu "id"
	 */
	...
	public static function saveVaccination($vaccination)
	{
		...
		try
		{
			...
			Logger::loggerOperation('Novo registro de vacinação adicionado. [idPerson='.$vacc[VCN_ID_PERSON].']');
	...
	public static function deleteVaccinations($idPerson)
	{
		try
		{
			...
			Logger::loggerOperation('Registros de vacinação removidos. [idPerson='.$vacc[VCN_ID_PERSON].']');
		}
		catch(Zend_Exception $e)
		{
			Logger::loggerError("Caught exception: ".get_class($e)."\nMessage: ".$e->getMessage());
	...
	/**
	 * Carrega do banco as informações de vacinação conforme "id" do usuário
	 */
	...
	/**
	 * Carrega do banco as informações de vacinação e vacina conforme "id" do usuário
	 */
