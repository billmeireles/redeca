 ...
 * Author                                           Date                               History 
 * -----------------------------------------        ------------                       ------------------ 
 * Jefferson Barros Lima  - S2it		    			26/03/2008	                       Create file 
 * 
 */
...
class TelephoneBusiness extends BasicBusiness
{
	...
	/**
	 * 
	 * Recupera telefone pelo número e ID da pessoa
	 * @param int $number
	 * @param int $id
	 */
	public static function loadById($id)
	{
		...
		try
		{
			...
			$where = $obj->getAdapter()->quoteInto(TNB_ID_TELEPHONE_NUMBER.' = ?', $id);
