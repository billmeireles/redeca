 ...
 * Author                                           Date                               History 
 * -----------------------------------------        ------------                       ------------------ 
 * Jefferson Barros Lima  - S2it		   				02/04/2008	                       Create file 
 * 
 */
...
class TableMapping
{
	// Mapa de tabelas que snão usadas na visualização de histÃ³rico
	private static $tableMap = array();
	// constants
	public static $_cn = 'class_name'; 		// Nome da classe 
	public static $_tn = 'template_name';	// Caminho/nome_do_template (sem a extensnão ".phtml")
	...
	private function init()
	{
		...
		self::$tableMap[TBL_VACCINATION] 	= array( 
			TableMapping::$_cn => CLS_VACCINATION, 
			TableMapping::$_rn => "Health",
			TableMapping::$_tv => "vaccinationByPerson",
			TableMapping::$_tn => 'health/healthPreview'
			);
