 ...
 * Author                                           Date                               History 
 * -----------------------------------------        ------------                       ------------------ 
 * Fabio Montezuma  - S2it		   					25/10/2010	                       Create file 
 * 
 */

define('HLP_ID_HEALTHPLAN','id_health_plan');
define('HLP_NAME','name');
define('HLP_STATUS','status');

class HealthPlan extends Zend_Db_Table_Abstract
{
	protected $_name = TBL_HEALTH_PLAN;
	protected $_primary = HLP_ID_HEALTHPLAN;
	
	protected $_dependentTables = array(CLS_HEALTH);
}