...
define('VCN_ID_VACCINATION','id_vaccination');
define('VCN_ID_PERSON','id_person');
define('VCN_ID_VACCINE','id_vaccine');
define('VCN_DATE','date');
define('VCN_LOT','lot');
define('VCN_STATUS','status');

require_once (CLS_PERSON.".php");
require_once (CLS_VACCINE.".php");

class Vaccination extends Zend_Db_Table_Abstract
{
	protected $_name = TBL_VACCINATION;
	protected $_primary = VCN_ID_VACCINATION;
	
	protected $_referenceMap    = array(
        CLS_PERSON => array(
            'columns'           => VCN_ID_PERSON,
            'refTableClass'     => CLS_PERSON,
            'refColumns'        => PRS_ID_PERSON
        ),        
        CLS_VACCINE => array(
            'columns'           => VCN_ID_VACCINE,
            'refTableClass'     => CLS_VACCINE,
            'refColumns'        => VAC_ID_VACCINE
        )
    );
