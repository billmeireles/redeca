...
define('VCT_ID_VACCINE_TYPE','id_vaccine_type');
define('VCT_DESCRIPTION','description');
define('VCT_STATUS','status');

class VaccineType extends Zend_Db_Table_Abstract
{
	protected $_name = TBL_VACCINETYPE;
	protected $_primary = VCT_ID_VACCINE_TYPE;
	
	protected $_dependentTables = array(CLS_VACCINE);
}