 ...
 * Pedro Henrique Ferro Gorla	- S2it				11/04/2012						   Edit file 
 * 
 */
...
define('TBL_AGE_GROUP', 'per_age_group');
...
define('TBL_CLASS_HISTORY', 'act_class_history');
...
define('TBL_HEALTH_PLAN', 'hlt_health_plan');
define('TBL_VACCINE', 'hlt_vaccine');
define('TBL_VACCINE_TYPE', 'hlt_vaccine_type');
define('TBL_VACCINATION', 'hlt_vaccination');
define('TBL_VACCINE_PERIOD','hlt_period');
...
define('CLS_HEALTHPLAN','HealthPlan');
define('CLS_VACCINE','Vaccine');
define('CLS_VACCINE_TYPE','VaccineType');
define('CLS_VACCINATION','Vaccination');
define('CLS_VACCINE_PERIOD','Period');
/*prefix per */
