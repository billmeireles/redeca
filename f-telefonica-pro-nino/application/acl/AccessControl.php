 ...
 * Author                                           Date                               History 
 * -----------------------------------------        ------------                       ------------------ 
 * Saulo Esteves Rodrigues  - S2it         			30/01/2008                         Create file 
 * 
 */
?>
<?php
class AccessControl extends Zend_Acl
{
	public function __construct(Zend_Auth $auth)
	{
		...
		try
		{
			...
			$this->add(new Zend_Acl_Resource(controller_name(MONITORING_CONTROLLER)));
