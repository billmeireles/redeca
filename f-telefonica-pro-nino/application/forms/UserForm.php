...
class UserForm extends BasicForm
{
	...
	/**
	 * Recupera as informaçãões do form e retorna no array
	 * 
	 */
	function assembleFormToUser(UserForm $frm)
	{
		...
		$profs = $frm->getIdProfile();
		if (sizeof($profs) == 1 && empty($profs[0]))
			$user[F_ID_PROFILE]		= array();
		else
	...
	/*
	 * Recupera as informaçãões do objeto e insere no form
	 * 
	 */
